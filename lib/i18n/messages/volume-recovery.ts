...
export const volumeRecoveryMessages = {
  en: {
    volumeRecovery: {
      ...
      sorenessNoneSelected: "No sore muscles.",
      sorenessLegendTrained: "Trained this week",
      sorenessLegendLevel: "Mild → severe",
      sorenessLevelFor: (muscle: string) => `How sore: ${muscle}`,
      removeSoreMuscle: (muscle: string) => `Remove ${muscle}`,
  ...
  vi: {
    volumeRecovery: {
      ...
      sorenessLevels: [
        ...
        { value: 3, label: "Vừa" },
        { value: 4, label: "Nhiều" },
        { value: 5, label: "Dữ dội" },
      ],
      sorenessNoneSelected: "Không đau cơ nào.",
      sorenessLegendTrained: "Đã tập tuần này",
      sorenessLegendLevel: "Nhẹ → dữ dội",
      sorenessLevelFor: (muscle: string) => `Mức đau: ${muscle}`,
      removeSoreMuscle: (muscle: string) => `Bỏ ${muscle}`,
      sorenessMuscleButton: (muscle: string, level: string | null) =>
