...
- Landing `/` dùng dark trong pre-paint script và `AppProviders initialTheme`, không ghi đè theme preference đã lưu. Giao diện marketing dùng nền phẳng, đường kẻ mảnh và accent cobalt; authenticated shell vẫn dùng glass/theme preference.
